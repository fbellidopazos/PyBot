...
class Music(commands.Cog):
    ...
    @commands.command(name='connect',description="Connect to a given voice channel/channel you are in")
    ...
    @commands.command(name='play',description="Play´s song given by link" ,aliases=['sing'])
    ...
    @commands.command(name='volume',description="Chanegs music volume", aliases=['vol'])
    ...
    @commands.command(name='stop',description="Deletes current player")
